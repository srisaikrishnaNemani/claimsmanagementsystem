<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.Master" AutoEventWireup="true" CodeBehind="ForgetPasswordAdmin.aspx.cs" Inherits="Claim_Management_System.ForgetPasswordAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="user_login">
        ...
        <table style="width: 342px; margin: auto; margin-top: 30px; height: 246px">
            ...
            <tr style="width: 336px">
                <td style="width: 336px">NewPassword :
                </td>
                <td style="width: 336px">

<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.Master" AutoEventWireup="true" CodeBehind="MemberRegistration.aspx.cs" Inherits="Claim_Management_System.MemberRegistration" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">

    <div class="reg_content">
        <div class="auto-style16">
            <span style="font-size: xx-large">Member Registration</span><br />
            <br />
            <br />
            <br />
        </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.Master" AutoEventWireup="true" CodeBehind="MemberLogin.aspx.cs" Inherits="Claim_Management_System.MemberLogin" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="user_login">
        <h1 class="login_head">Member Login</h1>

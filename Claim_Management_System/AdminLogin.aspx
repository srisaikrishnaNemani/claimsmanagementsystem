<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.Master" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="Claim_Management_System.AdminLogin" %>
    ...
    <div class="user_login">
        ...
        <table style="width: 342px; margin: auto; margin-top: 30px; height: 246px">
            ...
            <tr>
                <td style="width: 336px">&nbsp;</td>
                <td style="width: 336px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPassword" ErrorMessage="Password Required!" Style="color: #FF0000; width: auto"></asp:RequiredFieldValidator>
                    <br />
                    <br />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AdminRegistration.aspx" Style="color: #0066FF">New Admin Register Here!</asp:HyperLink>

                </td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left">
                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/ForgetPasswordAdmin.aspx" Style="color: #0066FF">Forget Password</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td colspan="2">
